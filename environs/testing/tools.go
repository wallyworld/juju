...
func (s *ToolsFixture) UploadFakeToolsToDirectory(c *tc.C, dir, toolsDir, stream string) {
...
func (s *ToolsFixture) UploadFakeTools(c *tc.C, stor storage.Storage, toolsDir, stream string) {
...
func PrimeTools(c *tc.C, stor storage.Storage, dataDir, toolsDir string, vers version.Binary) *coretools.Tools {
...
func InstallFakeDownloadedTools(c *tc.C, dataDir string, vers version.Binary) *coretools.Tools {
	tgz, checksum := makeFakeTools(vers)
...
func AssertUploadFakeToolsVersions(c *tc.C, stor storage.Storage, toolsDir, stream string, versions ...version.Binary) []*coretools.Tools {
...
func UploadFakeTools(c *tc.C, stor storage.Storage, toolsDir, stream string, arches ...string) {
	if len(arches) == 0 {
