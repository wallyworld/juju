...
func (t *Tests) Open(c *tc.C, ctx stdcontext.Context, cfg *config.Config) environs.Environ {
...
func (t *Tests) SetUpTest(c *tc.C) {
	...
	ctx := stdcontext.WithValue(c.Context(), bootstrap.SimplestreamsFetcherContextKey, ss)
