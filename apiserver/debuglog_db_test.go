...
func TestDebugLogDBSuite(t *tctesting.T) {
	coretesting.MgoTestPackage(t, &debugLogDBSuite{})
}
...
func (s *debugLogDBSuite) TestBadParams(c *tc.C) {
...
func (s *debugLogDBSuite) TestWithHTTP(c *tc.C) {
...
func (s *debugLogDBSuite) TestNoAuth(c *tc.C) {
...
func (s *debugLogDBSuite) TestUnitLoginsRejected(c *tc.C) {
...
func (s *debugLogDBSuite) TestUserLoginAccepted(c *tc.C) {
...
func (s *debugLogDBSuite) TestUserLoginRejected(c *tc.C) {
	u := s.Factory.MakeUser(c, &factory.UserParams{
		Name:        "oryx",
		Password:    "gardener",
		NoModelUser: true,
...
func (s *debugLogDBSuite) TestMachineLoginsAccepted(c *tc.C) {
...
func (s *debugLogDBSuite) dialWebsocket(c *tc.C, queryParams url.Values) *websocket.Conn {
...
func (s *debugLogDBSuite) dialWebsocketInternal(
	c *tc.C, queryParams url.Values, header http.Header,
