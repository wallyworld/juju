...
func (s *annotationsSuite) TestCheckKeysNonEmpty(c *tc.C) {
	c.Assert(s.annotations.CheckKeysNonEmpty("key1"), tc.Satisfies, errors.IsNotFound)

	s.annotations.Add("key1", "")
	c.Assert(s.annotations.CheckKeysNonEmpty("key1"), tc.Satisfies, errors.IsNotValid)

	s.annotations.Add("key2", "val2")
	c.Assert(s.annotations.CheckKeysNonEmpty("key2"), tc.ErrorIsNil)
	c.Assert(s.annotations.CheckKeysNonEmpty("key1", "key2"), tc.Satisfies, errors.IsNotValid)
}
