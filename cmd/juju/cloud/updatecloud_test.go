...
func TestUpdateCloudSuite(t *tctesting.T) {
...
func (s *updateCloudSuite) setupCloudFileScenario(c *tc.C, yamlFile string, apiFunc func() (cloud.UpdateCloudAPI, error)) (*cloud.UpdateCloudCommand, string) {
