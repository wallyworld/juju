...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/k8s_exec_mock.go github.com/juju/juju/internal/provider/kubernetes/exec Executor
