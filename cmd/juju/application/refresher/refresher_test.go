...
func TestRefresherFactorySuite(t *tctesting.T) {
...
func TestBaseRefresherSuite(t *tctesting.T) {
...
func TestLocalCharmRefresherSuite(t *tctesting.T) {
...
func TestCharmHubCharmRefresherSuite(t *tctesting.T) {
