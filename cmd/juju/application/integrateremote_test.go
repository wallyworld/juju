...
func TestAddRemoteRelationSuiteNewAPI(t *tctesting.T) {
...
func TestAddRelationValidationSuite(t *tctesting.T) {
...
func (s *baseAddRemoteRelationSuite) TearDownTest(c *tc.C) {
