...
func TestShowCommandSuite(t *tctesting.T) {
	tc.Run(t, &ShowCommandSuite{})
}
func TestShowSLACommandSuite(t *tctesting.T) {
	tc.Run(t, &showSLACommandSuite{})
}
...
func (s *ShowCommandSuite) TestShowBasicWithSLAIncompleteModelsYaml(c *tc.C) {
...
func (s *ShowCommandSuite) TestShowBasicWithSLAIncompleteModelsJson(c *tc.C) {
	basicAndSLAInfo := createBasicModelInfo()
	basicAndSLAInfo.SLA = &params.ModelSLAInfo{
		Owner: "owner",
		Level: "level",
...
func (s *showSLACommandSuite) SetUpTest(c *tc.C) {
