...
func (s *upgradeModelSuite) assertResetPreviousUpgrade(c *tc.C, answer string, expectUpgrade bool, args ...string) {
	s.reset(c)
...
func (s *upgradeModelSuite) TestResetPreviousUpgrade(c *tc.C) {
