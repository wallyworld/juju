...
type ManifoldsConfig struct {
	...
	// NewBrokerFunc is a function opens a CAAS provider.
	NewBrokerFunc jujucaas.NewBrokerFunc
...
func CAASManifolds(config ManifoldsConfig) dependency.Manifolds {
	manifolds := dependency.Manifolds{
		caasBrokerTrackerName: ifResponsible(caas.Manifold(caas.ManifoldConfig{
			APICallerName: apiCallerName,
