...
func (s *AgentSuite) SetUpSuite(c *tc.C) {
...
func (s *AgentSuite) PrimeAgentVersion(c *tc.C, tag names.Tag, password string, vers version.Binary) (agent.ConfigSetterWriter, *coretools.Tools) {
...
// configuration and the current tools.
func (s *AgentSuite) PrimeStateAgent(c *tc.C, tag names.Tag, password string) (agent.ConfigSetterWriter, *coretools.Tools) {
	vers := coretesting.CurrentVersion()
...
func (s *AgentSuite) PrimeStateAgentVersion(c *tc.C, tag names.Tag, password string, vers version.Binary) (
...
func (s *AgentSuite) SetControllerConfigAPIPort(c *tc.C, apiPort int) {
