...
func TestIpAddressesStateSuite(t *tctesting.T) {
	testing.MgoTestPackage(t, &ipAddressesStateSuite{})
}
...
func (s *ipAddressesStateSuite) SetUpTest(c *tc.C) {
...
func (s *ipAddressesStateSuite) TestMachineMethodReturnsMachine(c *tc.C) {
...
func (s *ipAddressesStateSuite) addNamedDeviceWithAddresses(
	c *tc.C, name string, addresses ...string,
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(deviceAddresses, tc.HasLen, len(addresses))
	return device, deviceAddresses
}

func (s *ipAddressesStateSuite) addNamedDevice(c *tc.C, name string) *state.LinkLayerDevice {
	return s.addNamedDeviceForMachine(c, name, s.machine)
}

func (s *ipAddressesStateSuite) addNamedDeviceForMachine(
	c *tc.C, name string, machine *state.Machine,
...
func (s *ipAddressesStateSuite) TestMachineMethodReturnsNotFoundErrorWhenMissing(c *tc.C) {
	_, addresses := s.addNamedDeviceWithAddresses(c, "eth0", "0.1.2.3/24")
...
func (s *ipAddressesStateSuite) ensureMachineDeadAndRemove(c *tc.C, machine *state.Machine) {
...
func (s *ipAddressesStateSuite) ensureEntityDeadAndRemoved(c *tc.C, entity ensureDeaderRemover) {
...
func (s *ipAddressesStateSuite) TestDeviceMethodReturnsLinkLayerDevice(c *tc.C) {
	addedDevice, addresses := s.addNamedDeviceWithAddresses(c, "eth0", "0.1.2.3/24")

	returnedDevice, err := addresses[0].Device()
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(returnedDevice, tc.DeepEquals, addedDevice)
}

func (s *ipAddressesStateSuite) TestDeviceMethodReturnsNotFoundErrorWhenMissing(c *tc.C) {
...
func (s *ipAddressesStateSuite) TestSubnetMethodReturnsSubnet(c *tc.C) {
	_, addresses := s.addNamedDeviceWithAddresses(c, "eth0", "10.20.30.41/16")

	result, err := addresses[0].Subnet()
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(result.CIDR(), tc.Equals, "10.20.0.0/16")
}

func (s *ipAddressesStateSuite) TestSubnetMethodReturnsNotFoundErrorWhenMissing(c *tc.C) {
	_, addresses := s.addNamedDeviceWithAddresses(c, "eth0", "10.20.30.41/16")
	...
	result, err := addresses[0].Subnet()
	c.Assert(err, tc.Satisfies, errors.IsNotFound)
	c.Assert(err, tc.ErrorMatches, `subnet "10.20.0.0/16" not found`)
	c.Assert(result, tc.IsNil)
}

func (s *ipAddressesStateSuite) TestSubnetMethodReturnsNotFoundErrorWithUnknownOrLocalSubnet(c *tc.C) {
	...
	c.Check(missingCIDRs.SortedValues(), tc.DeepEquals, []string{})
}

func (s *ipAddressesStateSuite) TestRemoveSuccess(c *tc.C) {
...
func (s *ipAddressesStateSuite) removeAddressAndAssertSuccess(c *tc.C, givenAddress *state.Address) {
	err := givenAddress.Remove()
	c.Assert(err, tc.ErrorIsNil)
}

func (s *ipAddressesStateSuite) assertNoAddressesOnMachine(c *tc.C, machine *state.Machine) {
	s.assertAllAddressesOnMachineMatchCount(c, machine, 0)
}

func (s *ipAddressesStateSuite) assertAllAddressesOnMachineMatchCount(
	c *tc.C, machine *state.Machine, expectedCount int,
) {
	results, err := machine.AllDeviceAddresses()
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(results, tc.HasLen, expectedCount, tc.Commentf(
		"expected %d, got %d: %+v", expectedCount, len(results), results))
}

func (s *ipAddressesStateSuite) TestRemoveTwiceStillSucceeds(c *tc.C) {
	_, existingAddresses := s.addNamedDeviceWithAddresses(c, "eth0", "0.1.2.3/24")
...
func (s *ipAddressesStateSuite) TestLinkLayerDeviceAddressesReturnsAllDeviceAddresses(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(resultAddresses, tc.DeepEquals, addedAddresses)
}

func (s *ipAddressesStateSuite) TestLinkLayerDeviceRemoveAddressesSuccess(c *tc.C) {
...
func (s *ipAddressesStateSuite) removeDeviceAddressesAndAssertNoneRemainOnMachine(
	c *tc.C, device *state.LinkLayerDevice,
) {
...
func (s *ipAddressesStateSuite) TestLinkLayerDeviceRemoveAddressesTwiceStillSucceeds(c *tc.C) {
	device, _ := s.addNamedDeviceWithAddresses(c, "eth0", "10.20.30.40/16", "fc00::/64")
	s.assertAllAddressesOnMachineMatchCount(c, s.machine, 2)
...
func (s *ipAddressesStateSuite) TestMachineRemoveAllAddressesSuccess(c *tc.C) {
	s.addTwoDevicesWithTwoAddressesEach(c)
	s.removeAllAddressesOnMachineAndAssertNoneRemain(c)
}

func (s *ipAddressesStateSuite) TestMachineRemoveAllAddressesRemovesProviderIDReferences(c *tc.C) {
...
func (s *ipAddressesStateSuite) addTwoDevicesWithTwoAddressesEach(c *tc.C) []*state.Address {
...
func (s *ipAddressesStateSuite) removeAllAddressesOnMachineAndAssertNoneRemain(c *tc.C) {
	err := s.machine.RemoveAllAddresses()
	c.Assert(err, tc.ErrorIsNil)
	s.assertNoAddressesOnMachine(c, s.machine)
}

func (s *ipAddressesStateSuite) TestMachineRemoveAllAddressesTwiceStillSucceeds(c *tc.C) {
	s.addTwoDevicesWithTwoAddressesEach(c)
	s.removeAllAddressesOnMachineAndAssertNoneRemain(c)
	s.removeAllAddressesOnMachineAndAssertNoneRemain(c)
}

func (s *ipAddressesStateSuite) TestMachineAllAddressesSuccess(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(allAddresses, tc.DeepEquals, addedAddresses)
}

func (s *ipAddressesStateSuite) TestLinkLayerDeviceRemoveAlsoRemovesDeviceAddresses(c *tc.C) {
	device, _ := s.addNamedDeviceWithAddresses(c, "eth0", "10.20.30.40/16", "fc00::/64")
	s.assertAllAddressesOnMachineMatchCount(c, s.machine, 2)
...
func (s *ipAddressesStateSuite) TestMachineRemoveAlsoRemovesAllAddresses(c *tc.C) {
	s.addTwoDevicesWithTwoAddressesEach(c)
	s.ensureMachineDeadAndRemove(c, s.machine)
	s.assertNoAddressesOnMachine(c, s.machine)
}

func (s *ipAddressesStateSuite) TestAllSpacesHandlesUnknownSubnets(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Check(spaces.SortedValues(), tc.DeepEquals, []string{})
}

func resetSubnet(c *tc.C, st *state.State, subnetInfo network.SubnetInfo) {
	// TODO (hml) 2019-07-26
...
func (s *ipAddressesStateSuite) TestAllSpacesOneSpace(c *tc.C) {
	s.addTwoDevicesWithTwoAddressesEach(c)
	...
	spaces, err := s.machine.AllSpaces()
	c.Assert(err, tc.ErrorIsNil)
	c.Check(spaces.SortedValues(), tc.DeepEquals, []string{space.Id()})
}

func (s *ipAddressesStateSuite) TestAllSpacesMultiSpace(c *tc.C) {
	s.addTwoDevicesWithTwoAddressesEach(c)
	...
	spaces, err := s.machine.AllSpaces()
	c.Assert(err, tc.ErrorIsNil)
	c.Check(spaces.SortedValues(), tc.DeepEquals, []string{space1.Id(), space2.Id()})
}

func (s *ipAddressesStateSuite) TestAllSpacesReturnsDefaultSpace(c *tc.C) {
	s.addTwoDevicesWithTwoAddressesEach(c)
	spaces, err := s.machine.AllSpaces()
	c.Assert(err, tc.ErrorIsNil)
	c.Check(spaces.SortedValues(), tc.DeepEquals, []string{network.AlphaSpaceId})
}

func (s *ipAddressesStateSuite) TestAllSpacesHandlesLoopbackAddresses(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(addresses, tc.HasLen, 3)
}

func (s *ipAddressesStateSuite) TestSetDevicesAddressesDoesNothingWithEmptyArgs(c *tc.C) {
	err := s.machine.SetDevicesAddresses() // takes varargs, which includes none.
	c.Assert(err, tc.ErrorIsNil)
}

func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWithEmptyCIDRAddress(c *tc.C) {
...
func (s *ipAddressesStateSuite) assertSetDevicesAddressesFailsValidationForArgs(
	c *tc.C, args state.LinkLayerDeviceAddress, errorCauseMatches string,
) {
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWithInvalidCIDRAddress(c *tc.C) {
	args := state.LinkLayerDeviceAddress{
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWithCIDRAddressWithoutMask(c *tc.C) {
	args := state.LinkLayerDeviceAddress{
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWithEmptyDeviceName(c *tc.C) {
	args := state.LinkLayerDeviceAddress{
		CIDRAddress: "0.1.2.3/24",
	}
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWithUnknownDeviceName(c *tc.C) {
	args := state.LinkLayerDeviceAddress{
		CIDRAddress:  "0.1.2.3/24",
		ConfigMethod: network.ConfigStatic,
		DeviceName:   "missing",
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWithInvalidGatewayAddress(c *tc.C) {
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesOKWhenCIDRAddressDoesNotMatchKnownSubnet(c *tc.C) {
	...
	assertDeviceHasOneAddressWithSubnetCIDREquals := func(subnetCIDR string) {
		...
		c.Assert(addresses[0].SubnetCIDR(), tc.Equals, subnetCIDR)
	}
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWhenCIDRAddressMatchesDeadSubnet(c *tc.C) {
	s.addNamedDevice(c, "eth0")
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesFailsWhenMachineNotAliveOrGone(c *tc.C) {
	...
	c.Assert(err, tc.ErrorMatches, `.*: machine "0" not alive`)
	...
	err = s.otherStateMachine.SetDevicesAddresses(args)
	c.Assert(err, tc.ErrorMatches, `.*: DeviceName "eth0" on machine "0" not found`)
}

func (s *ipAddressesStateSuite) TestSetDevicesAddressesUpdatesExistingDocs(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(updatedAddresses, tc.HasLen, len(initialAddresses))
...
func (s *ipAddressesStateSuite) TestRemoveAddressRemovesProviderID(c *tc.C) {
	device := s.addNamedDevice(c, "eth0")
	addrArgs := state.LinkLayerDeviceAddress{
		DeviceName:   "eth0",
		ConfigMethod: network.ConfigManual,
...
func (s *ipAddressesStateSuite) TestChangeOriginOpsNoProviderID(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	addr := addrs[0]
	c.Assert(addr.Origin(), tc.Equals, network.OriginMachine)

	// No operations for setting the same origin.
	c.Assert(addr.SetOriginOps(network.OriginMachine), tc.IsNil)
...
func (s *ipAddressesStateSuite) TestChangeOriginOpsWithProviderID(c *tc.C) {
	dev := s.addNamedDevice(c, "eth0")
	...
	// No operations for setting the same origin.
	c.Assert(addr.SetOriginOps(network.OriginProvider), tc.IsNil)
	...
	addr = addrs[0]
	c.Assert(addr.Origin(), tc.Equals, network.OriginMachine)
	c.Assert(addr.ProviderID().String(), tc.Equals, "")
...
func (s *ipAddressesStateSuite) TestSetProviderIDOps(c *tc.C) {
	dev := s.addNamedDevice(c, "eth0")
	...
	c.Assert(err, tc.ErrorIsNil)
	addr = addrs[0]
	c.Assert(addr.ProviderID().String(), tc.Equals, "p1")
	c.Assert(addr.Origin(), tc.Equals, network.OriginProvider)
...
func (s *ipAddressesStateSuite) TestSetProviderNetIDsOps(c *tc.C) {
	dev := s.addNamedDevice(c, "eth0")
	...
	c.Assert(addr.ProviderNetworkID().String(), tc.Equals, "p-net-2")
	c.Assert(addr.ProviderSubnetID().String(), tc.Equals, "p-sub-2")
}

func (s *ipAddressesStateSuite) TestUpdateOps(c *tc.C) {
	dev := s.addNamedDevice(c, "eth0")
	...
	addrs, err = dev.Addresses()
	c.Assert(err, tc.ErrorIsNil)
	c.Check(addrs[0].GatewayAddress(), tc.Equals, "0.1.2.0")
	c.Check(addrs[0].IsSecondary(), tc.Equals, true)
}

func (s *ipAddressesStateSuite) TestUpdateAddressFailsToChangeProviderID(c *tc.C) {
	s.addNamedDevice(c, "eth0")
	addrArgs := state.LinkLayerDeviceAddress{
		DeviceName:   "eth0",
		ConfigMethod: network.ConfigManual,
...
func (s *ipAddressesStateSuite) TestUpdateAddressPreventsDuplicateProviderID(c *tc.C) {
	s.addNamedDevice(c, "eth0")
	addrArgs := state.LinkLayerDeviceAddress{
		DeviceName:   "eth0",
		ConfigMethod: network.ConfigManual,
...
func (s *ipAddressesStateSuite) checkAddressMatchesArgs(
	c *tc.C, address *state.Address, args state.LinkLayerDeviceAddress,
) {
	c.Check(address.DeviceName(), tc.Equals, args.DeviceName)
	c.Check(address.MachineID(), tc.Equals, s.machine.Id())
	c.Check(args.CIDRAddress, tc.HasPrefix, address.Value())
	c.Check(address.ConfigMethod(), tc.Equals, args.ConfigMethod)
	c.Check(address.ProviderID(), tc.Equals, args.ProviderID)
	c.Check(address.DNSServers(), tc.DeepEquals, args.DNSServers)
	c.Check(address.DNSSearchDomains(), tc.DeepEquals, args.DNSSearchDomains)
	c.Check(address.GatewayAddress(), tc.Equals, args.GatewayAddress)
}

func (s *ipAddressesStateSuite) TestSetDevicesAddressesWithMultipleUpdatesOfSameDocLastUpdateWins(c *tc.C) {
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesMultipleDevicesWithSameAddress(c *tc.C) {
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesMultipleDevicesWithSameAddressDifferentProviderIDFails(c *tc.C) {
	_ = s.addNamedDeviceForMachine(c, "eth2", s.machine)
	_ = s.addNamedDeviceForMachine(c, "br0", s.machine)
	...
	err := s.machine.SetDevicesAddresses(addressArgs...)
	c.Assert(err, tc.ErrorMatches, `.*multiple addresses "0.1.2.3", "0.1.2.4": provider IDs not unique: 42`)
}

func (s *ipAddressesStateSuite) TestSetDevicesAddressesWithDuplicateProviderIDFailsInSameModel(c *tc.C) {
...
func (s *ipAddressesStateSuite) TestSetDevicesAddressesWithDuplicateProviderIDSucceedsInDifferentModel(c *tc.C) {
...
func (s *ipAddressesStateSuite) addDeviceWithAddressAndProviderIDForMachine(
	c *tc.C, providerID string, machine *state.Machine,
