...
func (cs *ConnWithWallClockSuite) SetUpTest(c *tc.C) {
...
func (s *ConnWithWallClockSuite) AddTestingCharm(c *tc.C, name string) *state.Charm {
	return state.AddTestingCharm(c, s.State, name)
}

func (s *ConnWithWallClockSuite) AddTestingApplication(c *tc.C, name string, ch *state.Charm) *state.Application {
	return state.AddTestingApplication(c, s.State, name, ch)
}

func (s *ConnWithWallClockSuite) AddTestingApplicationWithStorage(c *tc.C, name string, ch *state.Charm, storage map[string]state.StorageConstraints) *state.Application {
	return state.AddTestingApplicationWithStorage(c, s.State, name, ch, storage)
}

func (s *ConnWithWallClockSuite) AddTestingApplicationWithBindings(c *tc.C, name string, ch *state.Charm, bindings map[string]string) *state.Application {
	return state.AddTestingApplicationWithBindings(c, s.State, name, ch, bindings)
}

func (s *ConnWithWallClockSuite) AddSeriesCharm(c *tc.C, name, series string) *state.Charm {
...
// revision.
func (s *ConnWithWallClockSuite) AddConfigCharm(c *tc.C, name, configYaml string, revision int) *state.Charm {
...
func (s *ConnWithWallClockSuite) AddActionsCharm(c *tc.C, name, actionsYaml string, revision int) *state.Charm {
...
func (s *ConnWithWallClockSuite) AddMetaCharm(c *tc.C, name, metaYaml string, revision int) *state.Charm {
...
// given YAML string and adds it to the state, using the given revision.
func (s *ConnWithWallClockSuite) AddMetricsCharm(c *tc.C, name, metricsYaml string, revision int) *state.Charm {
...
func (s *ConnWithWallClockSuite) NewStateForModelNamed(c *tc.C, modelName string) *state.State {
