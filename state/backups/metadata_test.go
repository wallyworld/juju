...
func (s *metadataSuite) TestNewMetadataJSONReaderV0(c *tc.C) {
	...
	c.Check(meta.FormatVersion, tc.Equals, int64(0))
	c.Check(meta.Controller.UUID, tc.Equals, "")
	c.Check(meta.Controller.HANodes, tc.Equals, int64(0))
	c.Check(meta.Controller.MachineInstanceID, tc.Equals, "")
	c.Check(meta.Controller.MachineID, tc.Equals, "")
}
