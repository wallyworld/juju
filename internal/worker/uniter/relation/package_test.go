...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/mock_state_tracker_state.go github.com/juju/juju/internal/worker/uniter/relation StateTrackerState
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/mock_uniter_api.go github.com/juju/juju/internal/worker/uniter/relation Unit,Relation,RelationUnit
