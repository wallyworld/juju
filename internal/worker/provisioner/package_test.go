...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/provisioner.go github.com/juju/juju/internal/worker/provisioner ContainerMachine,ContainerMachineGetter,TaskAPI
