...
func (factory *Factory) MakeUser(c *tc.C, params *UserParams) *state.User {
	if params == nil {
		params = &UserParams{}
	}
	if params.Name == "" {
...
// defaults are used.
func (factory *Factory) MakeModelUser(c *tc.C, params *ModelUserParams) permission.UserAccess {
	if params == nil {
...
//
// If params is not specified, defaults are used.
func (factory *Factory) MakeCharm(c *tc.C, params *CharmParams) *state.Charm {
	if params == nil {
		params = &CharmParams{}
	}
	if params.Name == "" {
...
func (factory *Factory) MakeCharmV2(c *tc.C, params *CharmParams) *state.Charm {
	if params == nil {
		params = &CharmParams{}
	}
	if params.Name == "" {
...
// If params is not specified, defaults are used.
func (factory *Factory) MakeApplication(c *tc.C, params *ApplicationParams) *state.Application {
...
func (factory *Factory) MakeApplicationReturningPassword(c *tc.C, params *ApplicationParams) (*state.Application, string) {
	if params == nil {
...
// to a machine.
func (factory *Factory) MakeUnit(c *tc.C, params *UnitParams) *state.Unit {
...
// machine.
func (factory *Factory) MakeUnitReturningPassword(c *tc.C, params *UnitParams) (*state.Unit, string) {
	if params == nil {
		params = &UnitParams{}
	}
	model, err := factory.st.Model()
...
// If params is not specified, defaults are used.
func (factory *Factory) MakeRelation(c *tc.C, params *RelationParams) *state.Relation {
	if params == nil {
...
func (factory *Factory) MakeSpace(c *tc.C, params *SpaceParams) *state.Space {
	if params == nil {
