...
func TestLegacyEnvironBrokerSuite(t *tctesting.T) {
...
func (s *legacyEnvironBrokerSuite) TestStartInstanceLoginErrorInvalidatesCreds(c *tc.C) {
	...
	c.Assert(passedReason, tc.Equals, "cloud denied access: ServerFaultCode: You passed an incorrect user name or password, bucko.")
}
