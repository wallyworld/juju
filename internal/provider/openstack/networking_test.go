...
func (s *networkingSuite) TestNetworkInterfaces(c *tc.C) {
	...
	c.Assert(nic0.ProviderNetworkId, tc.Equals, network.Id("deadbeef-0bad-400d-8000-4b1ddbeefbeef"))
	...
	c.Assert(nic1.ProviderNetworkId, tc.Equals, network.Id("deadbeef-0bad-400d-8000-4b1ddbeefbeef"))
