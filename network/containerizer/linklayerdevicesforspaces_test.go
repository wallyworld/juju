...
func TestLinkLayerDevForSpacesSuite(t *tctesting.T) {
	tc.Run(t, &linkLayerDevForSpacesSuite{})
}

func (s *linkLayerDevForSpacesSuite) SetUpTest(c *tc.C) {
...
func (s *linkLayerDevForSpacesSuite) setupMocks(c *tc.C) *gomock.Controller {
